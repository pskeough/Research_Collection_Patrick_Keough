...
| **Access, Not Capability** | On private-corpus QA, a frontier API mostly sells document *access*: retrieval + a 4–8B local model closes most of the gap (judges can't separate them in 77% of pairs). | [Repo + paper](https://github.com/pskeough/access-not-capability) · arXiv preprint in preparation · TMLR target |
